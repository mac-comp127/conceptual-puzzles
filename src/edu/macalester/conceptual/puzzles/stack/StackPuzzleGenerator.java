...
class StackPuzzleGenerator {
    ...
    // Complexity tracking for difficulty balance
    ...
    public boolean isWellBalanced() {
        return objectCount >= ctx.getDifficulty() + 1
            && arrowCount >= ctx.getDifficulty() * 1.9f + 1
            && arrowCount <= ctx.getDifficulty() * 2.4f + 3;
    }
