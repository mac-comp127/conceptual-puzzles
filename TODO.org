...
Did not survive first contact with the enemy:

- forget overloading; at this level, we just have strings, and for the
  moment I want to stuff the logic of lookup from type or code into the
  factored-out methods. So just use different names, who'll probably
